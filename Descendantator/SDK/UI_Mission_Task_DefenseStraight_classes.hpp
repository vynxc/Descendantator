...
static_assert(sizeof(UUI_Mission_Task_DefenseStraight_C) == 0x000730, "Wrong size on UUI_Mission_Task_DefenseStraight_C");
static_assert(offsetof(UUI_Mission_Task_DefenseStraight_C, ANIM_Warning) == 0x000728, "Member 'UUI_Mission_Task_DefenseStraight_C::ANIM_Warning' has a wrong offset!");
