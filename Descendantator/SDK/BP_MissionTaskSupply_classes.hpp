...
static_assert(sizeof(ABP_MissionTaskSupply_C) == 0x0006A0, "Wrong size on ABP_MissionTaskSupply_C");
static_assert(offsetof(ABP_MissionTaskSupply_C, Billboard) == 0x000698, "Member 'ABP_MissionTaskSupply_C::Billboard' has a wrong offset!");
