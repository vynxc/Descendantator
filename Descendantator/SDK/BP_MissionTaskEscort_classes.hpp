...
{
public:
	class UBillboardComponent*                    Billboard;                                         // 0x06B0(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, NonTransactional, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(ABP_MissionTaskEscort_C) == 0x0006B8, "Wrong size on ABP_MissionTaskEscort_C");
static_assert(offsetof(ABP_MissionTaskEscort_C, Billboard) == 0x0006B0, "Member 'ABP_MissionTaskEscort_C::Billboard' has a wrong offset!");
