...
public:
	...
	struct FGameplayTagContainer                  PeriodSETags;                                      // 0x0850(0x0020)(Edit, BlueprintVisible)
	struct FGameplayTagContainer                  PeriodSEForwardingOpTags;                          // 0x0870(0x0020)(Edit, BlueprintVisible)
...
static_assert(sizeof(ASplineAOEBase_C) == 0x000890, "Wrong size on ASplineAOEBase_C");
...
static_assert(offsetof(ASplineAOEBase_C, PeriodSETags) == 0x000850, "Member 'ASplineAOEBase_C::PeriodSETags' has a wrong offset!");
static_assert(offsetof(ASplineAOEBase_C, PeriodSEForwardingOpTags) == 0x000870, "Member 'ASplineAOEBase_C::PeriodSEForwardingOpTags' has a wrong offset!");
