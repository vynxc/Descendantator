...
static_assert(sizeof(UI_ChattingItem_C_GetDecoratedSenderString) == 0x0002A0, "Wrong size on UI_ChattingItem_C_GetDecoratedSenderString");
...
static_assert(offsetof(UI_ChattingItem_C_GetDecoratedSenderString, CallFunc_GetLinkContextText_ReturnValue) == 0x000020, "Member 'UI_ChattingItem_C_GetDecoratedSenderString::CallFunc_GetLinkContextText_ReturnValue' has a wrong offset!");
static_assert(offsetof(UI_ChattingItem_C_GetDecoratedSenderString, CallFunc_GetChattingAccountName_ReturnValue) == 0x000038, "Member 'UI_ChattingItem_C_GetDecoratedSenderString::CallFunc_GetChattingAccountName_ReturnValue' has a wrong offset!");
static_assert(offsetof(UI_ChattingItem_C_GetDecoratedSenderString, K2Node_MakeStruct_FormatArgumentData) == 0x000048, "Member 'UI_ChattingItem_C_GetDecoratedSenderString::K2Node_MakeStruct_FormatArgumentData' has a wrong offset!");
static_assert(offsetof(UI_ChattingItem_C_GetDecoratedSenderString, CallFunc_Conv_StringToText_ReturnValue) == 0x000098, "Member 'UI_ChattingItem_C_GetDecoratedSenderString::CallFunc_Conv_StringToText_ReturnValue' has a wrong offset!");
static_assert(offsetof(UI_ChattingItem_C_GetDecoratedSenderString, CallFunc_GetChattingDisplayName_ReturnValue) == 0x0000B0, "Member 'UI_ChattingItem_C_GetDecoratedSenderString::CallFunc_GetChattingDisplayName_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(UI_ChattingItem_C_GetDecoratedSenderString, CallFunc_Conv_StringToText_ReturnValue_1) == 0x000110, "Member 'UI_ChattingItem_C_GetDecoratedSenderString::CallFunc_Conv_StringToText_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(UI_ChattingItem_C_GetDecoratedSenderString, CallFunc_IsEmpty_ReturnValue) == 0x000128, "Member 'UI_ChattingItem_C_GetDecoratedSenderString::CallFunc_IsEmpty_ReturnValue' has a wrong offset!");
static_assert(offsetof(UI_ChattingItem_C_GetDecoratedSenderString, K2Node_MakeStruct_FormatArgumentData_2) == 0x000130, "Member 'UI_ChattingItem_C_GetDecoratedSenderString::K2Node_MakeStruct_FormatArgumentData_2' has a wrong offset!");
static_assert(offsetof(UI_ChattingItem_C_GetDecoratedSenderString, CallFunc_GetSenderDecorateStyleID_ReturnValue) == 0x000180, "Member 'UI_ChattingItem_C_GetDecoratedSenderString::CallFunc_GetSenderDecorateStyleID_ReturnValue' has a wrong offset!");
static_assert(offsetof(UI_ChattingItem_C_GetDecoratedSenderString, Temp_string_Variable) == 0x000190, "Member 'UI_ChattingItem_C_GetDecoratedSenderString::Temp_string_Variable' has a wrong offset!");
static_assert(offsetof(UI_ChattingItem_C_GetDecoratedSenderString, CallFunc_Conv_StringToText_ReturnValue_2) == 0x0001A0, "Member 'UI_ChattingItem_C_GetDecoratedSenderString::CallFunc_Conv_StringToText_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(UI_ChattingItem_C_GetDecoratedSenderString, K2Node_MakeStruct_FormatArgumentData_3) == 0x0001B8, "Member 'UI_ChattingItem_C_GetDecoratedSenderString::K2Node_MakeStruct_FormatArgumentData_3' has a wrong offset!");
static_assert(offsetof(UI_ChattingItem_C_GetDecoratedSenderString, K2Node_MakeStruct_FormatArgumentData_4) == 0x000208, "Member 'UI_ChattingItem_C_GetDecoratedSenderString::K2Node_MakeStruct_FormatArgumentData_4' has a wrong offset!");
static_assert(offsetof(UI_ChattingItem_C_GetDecoratedSenderString, K2Node_MakeArray_Array) == 0x000258, "Member 'UI_ChattingItem_C_GetDecoratedSenderString::K2Node_MakeArray_Array' has a wrong offset!");
static_assert(offsetof(UI_ChattingItem_C_GetDecoratedSenderString, CallFunc_Format_ReturnValue) == 0x000268, "Member 'UI_ChattingItem_C_GetDecoratedSenderString::CallFunc_Format_ReturnValue' has a wrong offset!");
static_assert(offsetof(UI_ChattingItem_C_GetDecoratedSenderString, CallFunc_Conv_TextToString_ReturnValue) == 0x000280, "Member 'UI_ChattingItem_C_GetDecoratedSenderString::CallFunc_Conv_TextToString_ReturnValue' has a wrong offset!");
static_assert(offsetof(UI_ChattingItem_C_GetDecoratedSenderString, K2Node_Select_Default) == 0x000290, "Member 'UI_ChattingItem_C_GetDecoratedSenderString::K2Node_Select_Default' has a wrong offset!");
