...
static_assert(offsetof(DeathStalkerACCHpRatioValue_C_CalculateValue, CallFunc_FromInt_ReturnValue) == 0x000018, "Member 'DeathStalkerACCHpRatioValue_C_CalculateValue::CallFunc_FromInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(DeathStalkerACCHpRatioValue_C_CalculateValue, CallFunc_FromFloat_ReturnValue) == 0x000020, "Member 'DeathStalkerACCHpRatioValue_C_CalculateValue::CallFunc_FromFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(DeathStalkerACCHpRatioValue_C_CalculateValue, CallFunc_FromFloat_ReturnValue_1) == 0x000028, "Member 'DeathStalkerACCHpRatioValue_C_CalculateValue::CallFunc_FromFloat_ReturnValue_1' has a wrong offset!");
...
static_assert(offsetof(DeathStalkerACCHpRatioValue_C_CalculateValue, CallFunc_GreaterEqual_ScaledIntScaledInt_ReturnValue) == 0x000040, "Member 'DeathStalkerACCHpRatioValue_C_CalculateValue::CallFunc_GreaterEqual_ScaledIntScaledInt_ReturnValue' has a wrong offset!");
