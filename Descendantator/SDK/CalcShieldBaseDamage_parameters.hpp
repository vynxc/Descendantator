...
static_assert(sizeof(CalcShieldBaseDamage_C_DoCalculation) == 0x0002B0, "Wrong size on CalcShieldBaseDamage_C_DoCalculation");
...
static_assert(offsetof(CalcShieldBaseDamage_C_DoCalculation, MonsterCategory) == 0x000148, "Member 'CalcShieldBaseDamage_C_DoCalculation::MonsterCategory' has a wrong offset!");
static_assert(offsetof(CalcShieldBaseDamage_C_DoCalculation, CallFunc_GetRefStat_ReturnValue) == 0x000150, "Member 'CalcShieldBaseDamage_C_DoCalculation::CallFunc_GetRefStat_ReturnValue' has a wrong offset!");
static_assert(offsetof(CalcShieldBaseDamage_C_DoCalculation, CallFunc_Greater_ScaledIntScaledInt_ReturnValue) == 0x000158, "Member 'CalcShieldBaseDamage_C_DoCalculation::CallFunc_Greater_ScaledIntScaledInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(CalcShieldBaseDamage_C_DoCalculation, CallFunc_Conv_ScaledIntToString_ReturnValue) == 0x000160, "Member 'CalcShieldBaseDamage_C_DoCalculation::CallFunc_Conv_ScaledIntToString_ReturnValue' has a wrong offset!");
static_assert(offsetof(CalcShieldBaseDamage_C_DoCalculation, CallFunc_GetDamageRatio_Ratio) == 0x000170, "Member 'CalcShieldBaseDamage_C_DoCalculation::CallFunc_GetDamageRatio_Ratio' has a wrong offset!");
static_assert(offsetof(CalcShieldBaseDamage_C_DoCalculation, CallFunc_Conv_StringToText_ReturnValue) == 0x000178, "Member 'CalcShieldBaseDamage_C_DoCalculation::CallFunc_Conv_StringToText_ReturnValue' has a wrong offset!");
static_assert(offsetof(CalcShieldBaseDamage_C_DoCalculation, CallFunc_FromFloat_ReturnValue) == 0x000190, "Member 'CalcShieldBaseDamage_C_DoCalculation::CallFunc_FromFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(CalcShieldBaseDamage_C_DoCalculation, K2Node_MakeStruct_FormatArgumentData) == 0x000198, "Member 'CalcShieldBaseDamage_C_DoCalculation::K2Node_MakeStruct_FormatArgumentData' has a wrong offset!");
static_assert(offsetof(CalcShieldBaseDamage_C_DoCalculation, CallFunc_Multiply_ScaledIntScaledInt_ReturnValue) == 0x0001E8, "Member 'CalcShieldBaseDamage_C_DoCalculation::CallFunc_Multiply_ScaledIntScaledInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(CalcShieldBaseDamage_C_DoCalculation, CallFunc_GetDamageRatio_Ratio_1) == 0x0001F0, "Member 'CalcShieldBaseDamage_C_DoCalculation::CallFunc_GetDamageRatio_Ratio_1' has a wrong offset!");
static_assert(offsetof(CalcShieldBaseDamage_C_DoCalculation, CallFunc_Conv_DoubleToString_ReturnValue) == 0x0001F8, "Member 'CalcShieldBaseDamage_C_DoCalculation::CallFunc_Conv_DoubleToString_ReturnValue' has a wrong offset!");
static_assert(offsetof(CalcShieldBaseDamage_C_DoCalculation, CallFunc_Conv_StringToText_ReturnValue_1) == 0x000208, "Member 'CalcShieldBaseDamage_C_DoCalculation::CallFunc_Conv_StringToText_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(CalcShieldBaseDamage_C_DoCalculation, K2Node_MakeStruct_FormatArgumentData_1) == 0x000220, "Member 'CalcShieldBaseDamage_C_DoCalculation::K2Node_MakeStruct_FormatArgumentData_1' has a wrong offset!");
static_assert(offsetof(CalcShieldBaseDamage_C_DoCalculation, K2Node_MakeArray_Array) == 0x000270, "Member 'CalcShieldBaseDamage_C_DoCalculation::K2Node_MakeArray_Array' has a wrong offset!");
static_assert(offsetof(CalcShieldBaseDamage_C_DoCalculation, CallFunc_Format_ReturnValue) == 0x000280, "Member 'CalcShieldBaseDamage_C_DoCalculation::CallFunc_Format_ReturnValue' has a wrong offset!");
static_assert(offsetof(CalcShieldBaseDamage_C_DoCalculation, CallFunc_Conv_TextToString_ReturnValue) == 0x000298, "Member 'CalcShieldBaseDamage_C_DoCalculation::CallFunc_Conv_TextToString_ReturnValue' has a wrong offset!");
static_assert(offsetof(CalcShieldBaseDamage_C_DoCalculation, CallFunc_FromFloat_InValue_ImplicitCast) == 0x0002A8, "Member 'CalcShieldBaseDamage_C_DoCalculation::CallFunc_FromFloat_InValue_ImplicitCast' has a wrong offset!");
