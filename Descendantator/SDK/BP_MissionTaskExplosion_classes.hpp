...
static_assert(sizeof(ABP_MissionTaskExplosion_C) == 0x0006D8, "Wrong size on ABP_MissionTaskExplosion_C");
static_assert(offsetof(ABP_MissionTaskExplosion_C, Billboard) == 0x0006D0, "Member 'ABP_MissionTaskExplosion_C::Billboard' has a wrong offset!");
