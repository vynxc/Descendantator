...
static_assert(sizeof(ABP_MissionTaskVoidBattleBoss_C) == 0x0006D8, "Wrong size on ABP_MissionTaskVoidBattleBoss_C");
static_assert(offsetof(ABP_MissionTaskVoidBattleBoss_C, UberGraphFrame) == 0x0006C8, "Member 'ABP_MissionTaskVoidBattleBoss_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(ABP_MissionTaskVoidBattleBoss_C, Billboard) == 0x0006D0, "Member 'ABP_MissionTaskVoidBattleBoss_C::Billboard' has a wrong offset!");
