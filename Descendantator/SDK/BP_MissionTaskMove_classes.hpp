...
static_assert(sizeof(ABP_MissionTaskMove_C) == 0x0006A0, "Wrong size on ABP_MissionTaskMove_C");
static_assert(offsetof(ABP_MissionTaskMove_C, UberGraphFrame) == 0x000690, "Member 'ABP_MissionTaskMove_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(ABP_MissionTaskMove_C, Billboard) == 0x000698, "Member 'ABP_MissionTaskMove_C::Billboard' has a wrong offset!");
