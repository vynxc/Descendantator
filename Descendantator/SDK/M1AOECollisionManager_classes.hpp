...
static_assert(sizeof(UM1AOECollisionManager_C) == 0x000170, "Wrong size on UM1AOECollisionManager_C");
...
static_assert(offsetof(UM1AOECollisionManager_C, PeriodSEForwardingContextTags) == 0x000130, "Member 'UM1AOECollisionManager_C::PeriodSEForwardingContextTags' has a wrong offset!");
static_assert(offsetof(UM1AOECollisionManager_C, PeriodSEInvokeTags) == 0x000150, "Member 'UM1AOECollisionManager_C::PeriodSEInvokeTags' has a wrong offset!");
