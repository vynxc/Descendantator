...
static_assert(sizeof(ABP_MissionSubTaskDestruction_C) == 0x000680, "Wrong size on ABP_MissionSubTaskDestruction_C");
static_assert(offsetof(ABP_MissionSubTaskDestruction_C, Billboard) == 0x000678, "Member 'ABP_MissionSubTaskDestruction_C::Billboard' has a wrong offset!");
