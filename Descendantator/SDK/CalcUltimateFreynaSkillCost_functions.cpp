...
#include "CalcUltimateFreynaSkillCost_classes.hpp"
#include "CalcUltimateFreynaSkillCost_parameters.hpp"
...
void UCalcUltimateFreynaSkillCost_C::DoCalculation(struct FM1AbilityOpCalcParam& Param, struct FM1CalcDamageInfo& DamageInfo, struct FM1AbilityOpExecCalcOutput& Output) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("CalcUltimateFreynaSkillCost_C", "DoCalculation");

	Params::CalcUltimateFreynaSkillCost_C_DoCalculation Parms{};
