...
static_assert(offsetof(SplineAOEBase_C_OnBeginOverlap, CallFunc_InvokeAllStatusEffectToTargetByTag_ReturnValue) == 0x000010, "Member 'SplineAOEBase_C_OnBeginOverlap::CallFunc_InvokeAllStatusEffectToTargetByTag_ReturnValue' has a wrong offset!");
...
static_assert(alignof(SplineAOEBase_C_InvokePeriodStatusEffect) == 0x000008, "Wrong alignment on SplineAOEBase_C_InvokePeriodStatusEffect");
static_assert(sizeof(SplineAOEBase_C_InvokePeriodStatusEffect) == 0x000050, "Wrong size on SplineAOEBase_C_InvokePeriodStatusEffect");
static_assert(offsetof(SplineAOEBase_C_InvokePeriodStatusEffect, Target) == 0x000000, "Member 'SplineAOEBase_C_InvokePeriodStatusEffect::Target' has a wrong offset!");
static_assert(offsetof(SplineAOEBase_C_InvokePeriodStatusEffect, Temp_struct_Variable) == 0x000008, "Member 'SplineAOEBase_C_InvokePeriodStatusEffect::Temp_struct_Variable' has a wrong offset!");
static_assert(offsetof(SplineAOEBase_C_InvokePeriodStatusEffect, Temp_name_Variable) == 0x000018, "Member 'SplineAOEBase_C_InvokePeriodStatusEffect::Temp_name_Variable' has a wrong offset!");
static_assert(offsetof(SplineAOEBase_C_InvokePeriodStatusEffect, CallFunc_IsValidTags_ReturnValue) == 0x000028, "Member 'SplineAOEBase_C_InvokePeriodStatusEffect::CallFunc_IsValidTags_ReturnValue' has a wrong offset!");
static_assert(offsetof(SplineAOEBase_C_InvokePeriodStatusEffect, CallFunc_BP_MakeForwardingContext_ReturnValue) == 0x000030, "Member 'SplineAOEBase_C_InvokePeriodStatusEffect::CallFunc_BP_MakeForwardingContext_ReturnValue' has a wrong offset!");
static_assert(offsetof(SplineAOEBase_C_InvokePeriodStatusEffect, CallFunc_InvokeAllStatusEffectToTargetByTag_ReturnValue) == 0x000040, "Member 'SplineAOEBase_C_InvokePeriodStatusEffect::CallFunc_InvokeAllStatusEffectToTargetByTag_ReturnValue' has a wrong offset!");
...
static_assert(alignof(SplineAOEBase_C_HasPeriod) == 0x000001, "Wrong alignment on SplineAOEBase_C_HasPeriod");
static_assert(sizeof(SplineAOEBase_C_HasPeriod) == 0x000006, "Wrong size on SplineAOEBase_C_HasPeriod");
static_assert(offsetof(SplineAOEBase_C_HasPeriod, ReturnValue) == 0x000000, "Member 'SplineAOEBase_C_HasPeriod::ReturnValue' has a wrong offset!");
static_assert(offsetof(SplineAOEBase_C_HasPeriod, CallFunc_IsValidTags_ReturnValue) == 0x000001, "Member 'SplineAOEBase_C_HasPeriod::CallFunc_IsValidTags_ReturnValue' has a wrong offset!");
static_assert(offsetof(SplineAOEBase_C_HasPeriod, CallFunc_IsValidTags_ReturnValue_1) == 0x000002, "Member 'SplineAOEBase_C_HasPeriod::CallFunc_IsValidTags_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(SplineAOEBase_C_HasPeriod, CallFunc_BooleanOR_ReturnValue) == 0x000003, "Member 'SplineAOEBase_C_HasPeriod::CallFunc_BooleanOR_ReturnValue' has a wrong offset!");
static_assert(offsetof(SplineAOEBase_C_HasPeriod, CallFunc_Greater_DoubleDouble_ReturnValue) == 0x000004, "Member 'SplineAOEBase_C_HasPeriod::CallFunc_Greater_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(SplineAOEBase_C_HasPeriod, CallFunc_BooleanAND_ReturnValue) == 0x000005, "Member 'SplineAOEBase_C_HasPeriod::CallFunc_BooleanAND_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(SplineAOEBase_C_ExecuteUbergraph_SplineAOEBase, CallFunc_HasPeriod_ReturnValue) == 0x00012C, "Member 'SplineAOEBase_C_ExecuteUbergraph_SplineAOEBase::CallFunc_HasPeriod_ReturnValue' has a wrong offset!");
